...
class ModernRoleSelector extends StatefulWidget {
  ...
  const ModernRoleSelector({super.key, required this.cubit});
...
class _ModernRoleSelectorState extends State<ModernRoleSelector> {
  ...
  void initState() {
    super.initState();
    selectedRole = widget.cubit.selectedRole;
  }

  @override
  void dispose() {
    widget.cubit.selectedRole = 'Student';
    super.dispose();
  }
  ...
  Widget _buildRoleOption({
    ...
    return InkWell(
      ...
      onTap: () {
        setState(() {
          selectedRole = value;
          widget.cubit.selectedRole = selectedRole;
        });
      },
      child: Padding(
