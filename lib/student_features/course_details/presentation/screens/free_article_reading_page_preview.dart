...
class FreeArticleReadingPagePreview extends StatefulWidget {
  final LessonModule lesson;
  final CourseDetailsCubit cubit;
  const FreeArticleReadingPagePreview(
      {super.key, required this.cubit, required this.lesson});

  @override
  State<FreeArticleReadingPagePreview> createState() =>
      _FreeArticleReadingPagePreviewState();
}

class _FreeArticleReadingPagePreviewState
    extends State<FreeArticleReadingPagePreview> {
