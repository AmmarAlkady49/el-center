...
class ModernBarChartForHomePage extends StatefulWidget {
  final Map<String, int> weeklyProgressData;
  const ModernBarChartForHomePage(
      {super.key, required this.weeklyProgressData});
...
class _ModernBarChartForHomePageState extends State<ModernBarChartForHomePage>
  ...
  Widget build(BuildContext context) {
    ...
    final totalLessons =
        widget.weeklyProgressData.values.fold(0, (a, b) => a + b);
    final maxY =
        (widget.weeklyProgressData.values.reduce((a, b) => a > b ? a : b) + 1)
            .toDouble();
          ...
          Expanded(
            child: BarChart(
              BarChartData(
                ...
                barGroups:
                    List.generate(widget.weeklyProgressData.length, (index) {
                  final value =
                      widget.weeklyProgressData.values.elementAt(index);
                  final colorStrength =
